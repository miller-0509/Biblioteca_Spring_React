...
const META_ESTADISTICAS = {
  ...
  prestamosEquiposActivos: { label: 'Préstamos de Equipos Activos', icon: CalendarCheck, color: 'indigo' },
  prestamosLibrosActivos: { label: 'Préstamos de Libros Activos', icon: BookmarkCheck, color: 'emerald' },
...
function Home() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      >
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            <span style={{ fontSize: 13, opacity: 0.85 }}>• Centro de Servicios y Gestión SENA</span>
          </div>
        ...
        <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          {puedeLibros && (
            <Link to="/libros">
              <button className="btn-secondary" style={{ background: 'rgba(255, 255, 255, 0.12)', color: '#ffffff', borderColor: 'rgba(255,255,255,0.2)' }}>
                <BookOpen size={15} />
      ...
      {tieneMultas && (
        <div className="alert error" style={{ padding: '16px 20px', borderRadius: 12 }}>
          <ShieldAlert size={22} style={{ flexShrink: 0 }} />
          <div>
            <strong>Atención: Tienes sanciones activas o en proceso.</strong>
